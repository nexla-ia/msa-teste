/*
  # Fix: Corrigir status 'processado' para 'concluido' nas funções de processamento de pontos

  ## Problema
  - As funções inserem status = 'processado' na tabela atividades
  - O constraint atividades_status_check só permite: 'pendente', 'concluido', 'cancelado'

  ## Solução
  - Dropar e recriar as 3 funções com status = 'concluido'
  - Corrigir também as verificações de duplicidade que buscam status = 'processado'
*/
