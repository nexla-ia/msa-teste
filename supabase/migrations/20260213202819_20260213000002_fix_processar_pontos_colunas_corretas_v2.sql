/*
  # Fix: Corrigir Nomes das Colunas nas Funções de Processar Pontos (v2)

  ## Problema
  - As funções estavam usando nomes de colunas que não existem na tabela `programas_clubes`
  - Colunas incorretas: `ativo`, `pontos_acumulo`, `valor_mensalidade`, `data_assinatura`

  ## Colunas Corretas
  - `tem_clube` (boolean) - indica se o clube está ativo
  - `quantidade_pontos` - quantidade de pontos do clube
  - `valor` - valor da mensalidade
  - `data_ultima_assinatura` - data de assinatura do clube
  - `bonus_quantidade_pontos` - pontos de bônus
  - `bonus_porcentagem` - usado como frequência de bônus (1, 3, 6, 12)

  ## Solução
  - Recriar as três funções com os nomes corretos das colunas
*/
...
-- =====================================================
-- 1. processar_pontos_mes_atual: Com colunas corretas
-- =====================================================
...
-- =====================================================
-- 2. processar_pontos_retroativos: Com colunas corretas
-- =====================================================
...
-- =====================================================
-- 3. processar_creditos_clubes: Com colunas corretas
-- =====================================================
...
Uses correct column names: tem_clube, quantidade_pontos, valor, data_ultima_assinatura, bonus_quantidade_pontos, bonus_porcentagem.';
